...
def enrich_asn(asn: int) -> ASFeaturesRaw:
    ...
    return {
        ...
        'peeringdb_type':
        pdb_info.info_type if pdb_info is not None else None,
        'peeringdb_prefix_count_v4':
        pdb_info.info_prefixes4 if pdb_info is not None else None,
        'peeringdb_prefix_count_v6':
        pdb_info.info_prefixes6 if pdb_info is not None else None,
        'peeringdb_geographic_scope':
        pdb_info.info_scope if pdb_info is not None else None,
    }
